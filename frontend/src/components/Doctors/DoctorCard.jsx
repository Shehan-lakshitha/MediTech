...
const DoctorCard = ({ doctor }) => {
  ...
  return (
    <div className="p-3 lg:p-5">
      <div>
        <img src={photo} className="w-full h-[350px] rounded-[15px]  object-cover" alt="" />
      </div>
      ...
      <div className="mt-2 lg:mt-4 flex items-center justify-between">
        <span className="bg-[#CCF0F3] text-irisBlueColor py-1 px-2 lg:py-2 lg:px-6 text-[14px] leading-4 lg:text-[16px] lg:leading-7 font-semibold rounded-[10px]">
          {specialization}
        </span>
